...
export default function TasksView() {
  ...
  return (
    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', minHeight: 0 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16, flexShrink: 0, flexWrap: 'nowrap', minWidth: 0 }}>
        {/* View switcher */}
        <div style={{ display: 'flex', background: 'var(--mui-palette-background-paper)', borderRadius: 10, padding: 4, boxShadow: '0 1px 4px rgba(47,43,61,.1)', gap: 2, flexShrink: 0 }}>
        ...
        <button style={{ flexShrink: 0, background: 'var(--mui-palette-primary-main)', color: '#fff', border: 'none', borderRadius: 8, padding: '9px 18px', fontSize: '.8125rem', fontWeight: 700, display: 'flex', alignItems: 'center', gap: 6, boxShadow: '0 2px 6px rgba(201,124,74,.3)', cursor: 'pointer', fontFamily: 'inherit', whiteSpace: 'nowrap', marginLeft: view === 'timebox' ? 'auto' : 0 }}>
