...
export default function TasksView() {
  ...
  return (
    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', minHeight: 0 }}>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: 10, marginBottom: 16, flexShrink: 0 }}>

        {/* Row 1: view switcher + New Task button — always on same line */}
        ...
        {/* Search — hidden in timebox, wraps to next line on small screens */}
        {view !== 'timebox' && (
          <div style={{ flex: 1, minWidth: 200, width: '100%', background: 'var(--mui-palette-background-paper)', border: '1px solid var(--mui-palette-divider)', borderRadius: 8, padding: '8px 13px', display: 'flex', alignItems: 'center', gap: 7, boxShadow: '0 1px 4px rgba(47,43,61,.1)' }}>
